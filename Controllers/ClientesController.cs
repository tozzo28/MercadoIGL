...
namespace MercadoIGL.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("cpfCliente,nome,endereco")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("cpfCliente,nome,endereco")] Cliente cliente)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!ClienteExists(cliente.cpfCliente))
                    {
                        return NotFound();
                    }
                    else
